...
<body>
    ...
    <main class="main interna">
        ...
        <section class="login my-container my-paddings">
            <h1 class="login__title text-center">Inicia Sesión
            </h1>

            <div class="login-tabs">
                <ul class="nav nav-tabs tabs-listing">
                    <li class="nav-tabs__item">
                        <a href="#acceder" class="nav-link active">Acceder</a>
                    </li>
                    <li class="nav-tabs__item">
            ...
            <!--Acceder Formulario-->
            <div class="acceder tab-section" id="acceder">
                <form  class="formulario acceder-form" method="POST" action="<?php echo BASE_URL;?>/login">
                    <input type="hidden" name="form_type" value="acceder">
                    <!--Alert de exito-->
                    <?php if (!empty($mensaje_exito)) : ?>
                        <div class="formulario-alert acceder-form alert alert-info" role="alert">
                            <?php echo $mensaje_exito; ?>
                        </div>
                    <?php endif; ?>

                    <!-- Alerts errores -->
                    <?php foreach($errores_acceder as $error): ?>
                        <div class="formulario-alert acceder-form__alert alert alert-danger" role="alert">
                            <?php echo $error; ?>
                        </div>
                    <?php endforeach;?>

                    <!-- Alerts errores Front-end-->
                    <div class="formulario-alert acceder-form__alert alert alert-danger hidden" role="alert">
                    </div>

                    <!--Alert ERROR REGISTRO-->
                    <?php if (!empty($error_registro)) : ?>
                        <div class="formulario-alert registrarse-form__alert alert alert-danger" role="alert">
                            <?php echo $error_registro; ?>
                        </div>
                    <?php endif; ?>


                    <div class="formulario-group acceder-form__group--correo">
                        <label for="email_acceder">
                            Correo electrónico 
                        </label>
                        <input type="email" 
                        id="email_acceder" 
                        ...
                        value="<?php echo $email_acceder; ?>">
                    </div>
                    <div class="formulario-group acceder-form__group--contrasenia">
                        <label for="contrasenia_acceder">
                            Contraseña 
                        </label>
                        <input type="password" 
                        id="contrasenia_acceder" 
                        name="contrasenia_acceder" 
                        placeholder="Introduce tu contraseña"
                        value="<?php echo $contrasenia_acceder; ?>">
                    ...
                    <div class="formulario-group-row">
                        <div class="formulario-group acceder-form__group--sesion">
                            <input type="checkbox" id="sesion" name="sesion" value="1">
                            <label for="sesion">
                        ...
                        <div class="formulario-group">
                            <a href="<?php echo BASE_URL . '/restablecer-contrasenia'; ?>" class="restablecer-contrasenia">¿Olvidaste tu contraseña?</a>
                        </div>
                    </div>
            ...
            <div class="registrarse tab-section" id="registrarse">
                <form  class="formulario registrarse-form" method="POST" action="<?php echo BASE_URL;?>/login">
                    <input type="hidden" name="form_type" value="registro">
                    <!--Alert de exito-->
                    <?php if(isset($_SESSION['mensaje_exito'])) : ?>
                        <div class="formulario-alert registrarse-form alert alert-success" role="alert">
                    ...
                    <!-- Alerts errores Front-end-->
                    <div class="formulario-alert registrarse-form__alert alert alert-danger hidden" role="alert">
                    </div>

                    <div class="formulario-group registrarse-form__group--nombre">
                        <label for="nombre">
                    ...
                    <div class="formulario-group registrarse-form__group--contrasenia">
                    ...
                    <div class="formulario-group registrarse-form__group--contrasenia-confirm">
                    ...
                    <div class="formulario-group registrarse-form__group--politicas">
                        <input type="checkbox" id="politica" name="politica" value="1" required>
                        <label for="politica">
                            Acepto la <a href="javascript:void(0);alert('Próximamente...')"href="#">Política de Privacidad</a><span class="required"> *</span>
                        </label>
                    </div>
                    
                    <input type="submit" class="formulario-submit registrarse-form__submit btn-gold-block" value="Registrarse">

                </form>
            </div><!--/Registrarse Formulario-->
