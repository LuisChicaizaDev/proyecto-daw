<?php 
    //Head
    $currentPage = 'actualizar boxeador';
...
<body>
    ...
    <main class="main interna">
        <h1 class="text-center">Actualizar Boxeador</h1>

        <!--Publicar velada-->
        <section class="registrar-boxeador my-container my-paddings">
            <div class="registrar-boxeador__info">
                <p class="my-2">
                <strong>Aquí podrás actualizar cualquier detalle sobre tu boxeador</strong>. Recuerda rellanar los campos obligatorios (<span class="required">*</span>) para poder registrar correctamente a tu boxeador. 
            ...
            <div class="registrar-boxeador__formulario">
                <form class="formulario boxeador-form" method="POST">
                    ...
                    <div class="d-flex justify-content-between flex-wrap">
                        <div class="formulario-group boxeador-form__group--nombre">
                            ...
                            type="text" 
                            id="nombre" 
                            name="boxeador[nombre_boxeador]"  
                            placeholder="Ej. Pepito"
                            value="<?php echo $boxeador->nombre_boxeador; ?>" 
                            >
                        </div>
                        ...
                        <div class="formulario-group boxeador-form__group--apellido">
                            ...
                            type="text" 
                            id="apellido" 
                            name="boxeador[apellido_boxeador]" 
                            placeholder="Ej. Pérez"
                            value="<?php echo $boxeador->apellido_boxeador; ?>" 
                            >
                        </div>
                        <div class="formulario-group boxeador-form__group--peso">
                            ...
                            name="boxeador[peso]" 
                            placeholder="Ej. 60"
                            value="<?php echo $boxeador->peso; ?>" 
                            >
                        </div>
                    </div>      

                    <input type="submit" class="formulario-submit boxeador-form__submit btn-gold-block" value="Actualizar boxeador">
